    ...
    >
      ...
      <div className="flex flex-col w-1/2 text-jerry-green mx-[10vw] my-[10vh]">
        ...
        <div className="flex flex-col">
          <h2 className="text-[2vw] font-display min-[1480px]:text-[1.6vw]">This website</h2>
          <p className="text-[1.2vw] leading-tight min-[1480px]:text-[0.9vw]" style={{ fontFamily: '"Inter", sans-serif' }}>
        ...
        <div className="flex flex-col">
          <h2 className="text-[2vw] font-display min-[1480px]:text-[1.6vw]">Top skills</h2>
          <p className="text-[1.2vw] leading-tight min-[1480px]:text-[0.9vw]" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <div className="flex flex-col gap-[6vh] w-7/12 items-center relative z-50 min-[1480px]:gap-[4.5vh]">
        <AboutButton
