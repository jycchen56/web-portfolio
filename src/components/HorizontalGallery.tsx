...
const HorizontalGallery = () => {
  return (
    <div className="border-2 border-jerry-green rounded-[40px] py-[7vh] pr-[3vw] pl-[27vw] bg-[#FAF7F2] flex gap-[3vw] w-[55vw] h-[30vh] ml-[-25vw] items-center justify-center mt-[12vh]">
